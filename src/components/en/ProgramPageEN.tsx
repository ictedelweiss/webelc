  ...
  const programs = [
    {
      ...
      description: 'A homeschooling program with an international curriculum that maximizes students\' academic potential.',
    ...
    },
    {
      ...
      description: 'A professional English course with interactive and fun learning methods for all ages.',
    ...
    },
    {
      id: 'playteracy',
      title: 'Playteracy',
      description: 'A play-based learning program that develops children\'s literacy and social skills from an early age.',
    ...
    },
    {
      id: 'ipdc',
      title: 'IPDC',
      description: 'Indonesia Pedagogic Development Center - the center for curriculum and pedagogical methodology development in Indonesia.',
        ...
        <div className="relative pb-20">
          ...
          <div className="max-w-screen-xl mx-auto px-6 pt-8">
            ...
            <p className="text-sm font-poppins text-[#FED700]">
              Homepage <span className="text-[#868686]">|</span> Programs
            </p>
            ...
            <div className="mt-12">
              ...
              <p className="text-[#868686] font-poppins text-base md:text-lg max-w-[700px] leading-relaxed">
                Edelweiss Learning Center offers various innovative educational programs designed to comprehensively develop students' potential using the latest learning methods.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-screen-xl mx-auto px-6 py-12">
          ...
          <div className="mt-20 bg-[#F5F5F5] rounded-[20px] p-12">
            ...
            <p className="text-[#868686] font-poppins text-base text-center max-w-[700px] mx-auto mb-12">
              All programs are designed with international standards and adapted to the local needs of Indonesia.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-[15px] p-8">
                ...
                <p className="text-[#868686] font-poppins text-sm leading-relaxed">
                  Uses international standards that have been proven effective in improving student achievement.
                </p>
              </div>
              ...
              <div className="bg-white rounded-[15px] p-8">
                ...
                <p className="text-[#868686] font-poppins text-sm leading-relaxed">
                  A team of professional educators with international certifications and years of experience.
                </p>
              </div>
              ...
              <div className="bg-white rounded-[15px] p-8">
                ...
                <p className="text-[#868686] font-poppins text-sm leading-relaxed">
                  Programs can be tailored to the individual needs and learning styles of each student.
                </p>
              </div>
            </div>
          </div>
