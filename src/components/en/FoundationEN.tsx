export default function FoundationEN() {
  return (
      ...
      <div className="relative w-full">
        ...
        <div className="rounded-[15px] bg-[rgba(244,244,244,0.83)] mx-auto w-[90%] h-auto p-8 md:p-12 mb-20 relative">
          ...
          <p className="text-[#868686] font-poppins text-sm md:text-base mx-auto text-center max-w-[692px] leading-relaxed">
            The Sinar Putih Edelweiss Foundation was established on March 29, 2005, with the aim of providing quality educational services to the community through various programs oriented toward the comprehensive development of individual potential. The Sinar Putih Edelweiss Foundation is committed to cultivating a smart, character-driven, nationalistic generation with a global perspective.
          </p>
        </div>
        ...
        <div className="max-w-screen-xl mx-auto px-6 mb-12">
          ...
          <p className="text-[#293C88] font-poppins text-sm md:text-base">
            In an effort to achieve these goals, this foundation provides formal and non-formal educational services: 
          </p>
        </div>
        ...
        <div className="max-w-screen-xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8 mb-24">
          ...
          <div className="rounded-[44px] bg-[rgba(244,244,244,0.83)] p-8 md:p-12 overflow-hidden">
            ...
            <p className="text-[#868686] font-poppins text-sm md:text-base leading-relaxed max-w-[437px]">
              Provider of formal education focusing on holistic learning through Playgroup, Kindergarten, Elementary, and Junior High School levels.
            </p>
          </div>
          ...
          <div className="rounded-[44px] bg-[rgba(244,244,244,0.83)] p-8 md:p-12 overflow-hidden">
            ...
            <p className="text-[#868686] font-poppins text-sm md:text-base leading-relaxed max-w-[437px]">
              Provider of non-formal education housing several programs such as Elite Academia Homeschooling, 
              Playteracy, English Course, and Teacher Development Program.
            </p>
          </div>
        </div>
