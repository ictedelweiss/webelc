        ...
        <section className="relative w-full pt-16 pb-24 flex flex-col items-center z-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0 w-full max-w-screen-xl rounded-3xl lg:rounded-[69px] shadow-[0_4px_4px_0_rgba(0,0,0,0.25)] bg-white overflow-hidden">
            ...
            <div className="group relative w-full h-[320px] sm:h-[400px] md:h-[440px] lg:h-[520px] overflow-hidden border-t md:border-t-0 md:border-l border-white/20">
              <img src="/IPDC7.png" className="absolute inset-0 w-full h-full object-cover object-center transition-all duration-500 group-hover:scale-110 group-hover:blur-sm group-focus-within:scale-110 group-focus-within:blur-sm" alt="IPDC" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/10 to-transparent transition-colors duration-500 group-hover:from-black/95 group-hover:via-black/55 group-focus-within:from-black/95 group-focus-within:via-black/55"></div>
              <div className="absolute inset-x-0 bottom-0 p-4 md:p-8 flex flex-col items-start text-white">
            ...
            <div className="group relative w-full h-[320px] sm:h-[400px] md:h-[440px] lg:h-[520px] overflow-hidden border-t md:border-t-0 md:border-l lg:border-t-0 border-white/20">
              <img src="/playteracy-fix.png" className="absolute inset-0 w-full h-full object-cover transition-all duration-500 group-hover:scale-110 group-hover:blur-sm group-focus-within:scale-110 group-focus-within:blur-sm" alt="Playteracy" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/10 to-transparent transition-colors duration-500 group-hover:from-black/95 group-hover:via-black/55 group-focus-within:from-black/95 group-focus-within:via-black/55"></div>
              <div className="absolute inset-x-0 bottom-0 p-4 md:p-8 flex flex-col items-start text-white">
